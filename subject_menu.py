...
def creation_menu_subject(parent: tk, name: str) -> None:
    ...
    # Кнопки управления
    btn_stopwatch = ttk.Button(menu_subject, text="S T O P W A T C H", width=30, style="Big.TButton")
    btn_history = ttk.Button(menu_subject, text="H I S T O R Y", width=30, style="Big.TButton")
    btn_back = ttk.Button(menu_subject, text="B A C K", width=34, command=back_to)
