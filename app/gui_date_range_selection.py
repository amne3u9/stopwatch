...
def ask_date_range(parent: ctk.CTk, callback) -> None:
    """
    ...
    ctk.CTkLabel(
        ...
        text_color="#86868B"
    ).place(relx=0.06, rely=0.12, anchor="w")
    ...
    card_start.place(relx=0.5, rely=0.35, anchor="center")
    ...
    card_end.place(relx=0.5, rely=0.60, anchor="center")
